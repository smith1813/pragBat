...
var preference = {
  ...
  agentOrient: [
    ...
    ["straight","point_l", "point_r","down"],
    ["straight","point_r", "point_l","down"]],
  rightFruit: ["t1","t2","t3","t4","t5"],
  leftFruit: ["t6","t7","t8","t9","t10"],
...
// what happens between trials - display agent from previous trial and click on it to move on to the next trial  
   ...
   // get time for reaction time       
    ...
    var subid = preference.subid;
    var subage = preference.subage;    
    // data collected  
      data = {
        subid: subid,
        subage: subage,
        ...
        leftFruit: preference.leftFruit[0],
        rightFruit: preference.rightFruit[0],
        pref: preference.pref[0],
        pick: pick,
        correct: correct,
             };
