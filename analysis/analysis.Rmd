...
Here we extract and summarize the person specific $\alpha$ estimates and correalte them to performance in the card sorting and relational match-to-sample tasks.
...
Here we summarise the parameter esteimates for each test session and correlate them to get a measure of re-test reliability. 
