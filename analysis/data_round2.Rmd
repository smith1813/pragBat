...
item_info <- data_frame(
  task = c(rep("mutual_exclusivity",10),rep("simple_inf",10),rep("ad_hoc_implicature",10)),
  trial = c(rep(1:10,3)), 
  item = c(rep(c("carrot","garlic","eggplant","duck","horseshoe"),2),rep(c("bear","robot","rocket","truck","dino"),2), rep(c("box","chair","table","plate","house"),2))
)
